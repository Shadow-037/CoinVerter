<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="utenti.User,coin.Carrello,prodotti.ProductBean,java.util.Map,java.util.HashMap"%>
...
<body>
	...
	<div id="sideb" class="sidebar" hidden>
		<div id="sideover" onclick="openSidebar(this.id)"
			class="sidebarOverlay"></div>
		<div class="sidebarContent">
			<div class="sidebarHeader">
				<h4>WALLET</h4>
				<img onclick="openSidebar(this.id)" id="sidex" class="icon"
					src="img/icon/iconX.png" alt="">
			</div>
